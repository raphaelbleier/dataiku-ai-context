...
- `.windsurf/dataiku/generative-ai-llm.md` — LLM Mesh, connections, usage
- `.windsurf/dataiku/ai-agents.md` — Dataiku AI agents framework
- `.windsurf/dataiku/ai-assistants.md` — AI Assistants configuration
- `.windsurf/dataiku/semantic-models.md` — natural language to SQL
- `.windsurf/dataiku/dev-concepts-examples.md` — Python API: LLM Mesh section
...
# e.g.: python .windsurf/dataiku/graph_query.py "LLM mesh knowledge bank RAG embeddings"
```
