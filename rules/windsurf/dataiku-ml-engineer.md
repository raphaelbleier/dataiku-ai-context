...
- `.windsurf/dataiku/machine-learning.md` — Visual ML, AutoML, model training
- `.windsurf/dataiku/mlops.md` — deployment, monitoring, champions/challengers
- `.windsurf/dataiku/deployment.md` — production deployment patterns
- `.windsurf/dataiku/dev-concepts-examples.md` — Python API: Visual ML section
- `.windsurf/dataiku/api-node-deployer.md` — API Node and API Deployer
...
# e.g.: python .windsurf/dataiku/graph_query.py "model evaluation store deployment"
```
