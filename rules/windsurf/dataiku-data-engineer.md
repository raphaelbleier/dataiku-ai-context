...
trigger: glob
globs: ['**/*.py', '**/*.ipynb', '**/*.sql']
description: Dataiku data engineering specialist. Use for building data pipelines, optimizing recipes, managing scenarios and automation, working with SQL/Spark, and production data workflows.
---
...
- `.windsurf/dataiku/flow.md` — Flow, datasets, build behavior
- `.windsurf/dataiku/data-preparation.md` — Prepare recipe, formula language
- `.windsurf/dataiku/automation-scenarios.md` — scenarios, triggers, automation
- `.windsurf/dataiku/code-recipes.md` — Python/Spark/SQL recipes
- `.windsurf/dataiku/metrics-data-quality.md` — metrics, checks, DQ rules
- `.windsurf/dataiku/connecting-to-data.md` — connections, sync, formats
...
# e.g.: python .windsurf/dataiku/graph_query.py "spark partitioning recipe automation"
```
