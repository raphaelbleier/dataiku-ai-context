...
- `.windsurf/dataiku/python-api.md` — in-recipe Python API reference
- `.windsurf/dataiku/dev-concepts-examples.md` — dataikuapi cookbook (full reference)
- `.windsurf/dataiku/public-rest-api.md` — REST API endpoints
- `.windsurf/dataiku/api-node-deployer.md` — API Node and deployer
- `.windsurf/dataiku/dev-api-reference.md` — full API reference docs
...
# e.g.: python .windsurf/dataiku/graph_query.py "REST API project deployer prediction"
```
