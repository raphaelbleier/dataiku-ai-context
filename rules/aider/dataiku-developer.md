# Dataiku AI Context: dataiku-developer

> Load this file with `aider --read dataiku-docs/dataiku-developer.md`
...
- `dataiku-docs/concepts.md` — core DSS concepts
- `dataiku-docs/flow.md` — Flow and datasets
- `dataiku-docs/code-recipes.md` — Python/R/SQL/Spark recipes
- `dataiku-docs/dev-concepts-examples.md` — full Python API cookbook
- `dataiku-docs/python-api.md` — Python API reference
- `dataiku-docs/connecting-to-data.md` — connections and datasets
