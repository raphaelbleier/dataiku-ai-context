# Dataiku AI Context: dataiku-genai-engineer

> Load this file with `aider --read dataiku-docs/dataiku-genai-engineer.md`
...
- `dataiku-docs/generative-ai-llm.md` — LLM Mesh, connections, usage
- `dataiku-docs/ai-agents.md` — Dataiku AI agents framework
- `dataiku-docs/ai-assistants.md` — AI Assistants configuration
- `dataiku-docs/semantic-models.md` — natural language to SQL
- `dataiku-docs/dev-concepts-examples.md` — Python API: LLM Mesh section
...
# e.g.: python dataiku-docs/graph_query.py "LLM mesh knowledge bank RAG embeddings"
```
