# Dataiku AI Context: dataiku-api-developer

> Load this file with `aider --read dataiku-docs/dataiku-api-developer.md`
...
- `dataiku-docs/python-api.md` — in-recipe Python API reference
- `dataiku-docs/dev-concepts-examples.md` — dataikuapi cookbook (full reference)
- `dataiku-docs/public-rest-api.md` — REST API endpoints
- `dataiku-docs/api-node-deployer.md` — API Node and deployer
- `dataiku-docs/dev-api-reference.md` — full API reference docs
...
# e.g.: python dataiku-docs/graph_query.py "REST API project deployer prediction"
```
