# Dataiku AI Context: dataiku-ml-engineer

> Load this file with `aider --read dataiku-docs/dataiku-ml-engineer.md`
...
- `dataiku-docs/machine-learning.md` — Visual ML, AutoML, model training
- `dataiku-docs/mlops.md` — deployment, monitoring, champions/challengers
- `dataiku-docs/deployment.md` — production deployment patterns
- `dataiku-docs/dev-concepts-examples.md` — Python API: Visual ML section
- `dataiku-docs/api-node-deployer.md` — API Node and API Deployer
...
# e.g.: python dataiku-docs/graph_query.py "model evaluation store deployment"
```
