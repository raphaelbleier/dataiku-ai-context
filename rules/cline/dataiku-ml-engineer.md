...
- `.cline/dataiku/machine-learning.md` — Visual ML, AutoML, model training
- `.cline/dataiku/mlops.md` — deployment, monitoring, champions/challengers
- `.cline/dataiku/deployment.md` — production deployment patterns
- `.cline/dataiku/dev-concepts-examples.md` — Python API: Visual ML section
- `.cline/dataiku/api-node-deployer.md` — API Node and API Deployer
...
# e.g.: python .cline/dataiku/graph_query.py "model evaluation store deployment"
```
