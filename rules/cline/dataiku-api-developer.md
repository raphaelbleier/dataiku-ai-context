...
- `.cline/dataiku/python-api.md` — in-recipe Python API reference
- `.cline/dataiku/dev-concepts-examples.md` — dataikuapi cookbook (full reference)
- `.cline/dataiku/public-rest-api.md` — REST API endpoints
- `.cline/dataiku/api-node-deployer.md` — API Node and deployer
- `.cline/dataiku/dev-api-reference.md` — full API reference docs
...
# e.g.: python .cline/dataiku/graph_query.py "REST API project deployer prediction"
```
