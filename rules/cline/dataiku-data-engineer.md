...
- `.cline/dataiku/flow.md` — Flow, datasets, build behavior
- `.cline/dataiku/data-preparation.md` — Prepare recipe, formula language
- `.cline/dataiku/automation-scenarios.md` — scenarios, triggers, automation
- `.cline/dataiku/code-recipes.md` — Python/Spark/SQL recipes
- `.cline/dataiku/metrics-data-quality.md` — metrics, checks, DQ rules
- `.cline/dataiku/connecting-to-data.md` — connections, sync, formats
...
# e.g.: python .cline/dataiku/graph_query.py "spark partitioning recipe automation"
```
