...
- `.cline/dataiku/generative-ai-llm.md` — LLM Mesh, connections, usage
- `.cline/dataiku/ai-agents.md` — Dataiku AI agents framework
- `.cline/dataiku/ai-assistants.md` — AI Assistants configuration
- `.cline/dataiku/semantic-models.md` — natural language to SQL
- `.cline/dataiku/dev-concepts-examples.md` — Python API: LLM Mesh section
...
# e.g.: python .cline/dataiku/graph_query.py "LLM mesh knowledge bank RAG embeddings"
```
