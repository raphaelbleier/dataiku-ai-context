...
- `.github/dataiku/python-api.md` — in-recipe Python API reference
- `.github/dataiku/dev-concepts-examples.md` — dataikuapi cookbook (full reference)
- `.github/dataiku/public-rest-api.md` — REST API endpoints
- `.github/dataiku/api-node-deployer.md` — API Node and deployer
- `.github/dataiku/dev-api-reference.md` — full API reference docs
...
# e.g.: python .github/dataiku/graph_query.py "REST API project deployer prediction"
```
