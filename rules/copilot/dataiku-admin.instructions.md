...
- `.github/dataiku/installation.md` — install, upgrade, config
- `.github/dataiku/security.md` — auth, TLS, permissions
- `.github/dataiku/user-isolation.md` — per-user isolation
- `.github/dataiku/elastic-ai-containers.md` — Kubernetes, containers
- `.github/dataiku/dss-cloud.md` — cloud-specific deployment
- `.github/dataiku/operations.md` — backup, monitoring, tuning
- `.github/dataiku/code-envs.md` — Python/R environment management
...
# e.g.: python .github/dataiku/graph_query.py "LDAP security kubernetes installation"
```
