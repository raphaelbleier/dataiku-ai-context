...
- `.github/dataiku/generative-ai-llm.md` — LLM Mesh, connections, usage
- `.github/dataiku/ai-agents.md` — Dataiku AI agents framework
- `.github/dataiku/ai-assistants.md` — AI Assistants configuration
- `.github/dataiku/semantic-models.md` — natural language to SQL
- `.github/dataiku/dev-concepts-examples.md` — Python API: LLM Mesh section
...
# e.g.: python .github/dataiku/graph_query.py "LLM mesh knowledge bank RAG embeddings"
```
