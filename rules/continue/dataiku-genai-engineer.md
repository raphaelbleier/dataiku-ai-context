...
- `.continue/dataiku/generative-ai-llm.md` — LLM Mesh, connections, usage
- `.continue/dataiku/ai-agents.md` — Dataiku AI agents framework
- `.continue/dataiku/ai-assistants.md` — AI Assistants configuration
- `.continue/dataiku/semantic-models.md` — natural language to SQL
- `.continue/dataiku/dev-concepts-examples.md` — Python API: LLM Mesh section
...
# e.g.: python .continue/dataiku/graph_query.py "LLM mesh knowledge bank RAG embeddings"
```
