...
- `.continue/dataiku/python-api.md` — in-recipe Python API reference
- `.continue/dataiku/dev-concepts-examples.md` — dataikuapi cookbook (full reference)
- `.continue/dataiku/public-rest-api.md` — REST API endpoints
- `.continue/dataiku/api-node-deployer.md` — API Node and deployer
- `.continue/dataiku/dev-api-reference.md` — full API reference docs
...
# e.g.: python .continue/dataiku/graph_query.py "REST API project deployer prediction"
```
