...
- `.continue/dataiku/flow.md` — Flow, datasets, build behavior
- `.continue/dataiku/data-preparation.md` — Prepare recipe, formula language
- `.continue/dataiku/automation-scenarios.md` — scenarios, triggers, automation
- `.continue/dataiku/code-recipes.md` — Python/Spark/SQL recipes
- `.continue/dataiku/metrics-data-quality.md` — metrics, checks, DQ rules
- `.continue/dataiku/connecting-to-data.md` — connections, sync, formats
...
# e.g.: python .continue/dataiku/graph_query.py "spark partitioning recipe automation"
```
