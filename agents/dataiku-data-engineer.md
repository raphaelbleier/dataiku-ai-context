...
- `docs/flow.md` — Flow, datasets, build behavior
- `docs/data-preparation.md` — Prepare recipe, formula language
- `docs/automation-scenarios.md` — scenarios, triggers, automation
- `docs/code-recipes.md` — Python/Spark/SQL recipes
- `docs/metrics-data-quality.md` — metrics, checks, DQ rules
- `docs/connecting-to-data.md` — connections, sync, formats
